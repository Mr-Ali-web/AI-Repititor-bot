...
GEMINI_API_KEY = "AIzaSyB4YDehOLYyJKl5A_VUAU54jAENBOYaHfM"
...
def get_gemini_response(prompt):
    ...
    try:
        ...
        logger.error(f"Gemini 2.5 flash xatosi: {e}")
        ...
        try:
            ...
            logger.error(f"Gemini 2.5 pro xatosi: {e}")
...
# --- TO'LIQ KONFIGURATSIYA (MUHIM: o'zgartiring!) ---
TELEGRAM_TOKEN = "8665590507:AAEXHhP6_Blv8Ocikc9YCapV4w6nJk51Ni8"
GEMINI_API_KEY = "AIzaSyCUZ07eD0kiMhN_a2akXc7X7_PRlFeMgy0"
...
if __name__ == '__main__':
    main()
>>>>>>> 42a4daa6fc83f00d65809fff733c7b63afd1e617
